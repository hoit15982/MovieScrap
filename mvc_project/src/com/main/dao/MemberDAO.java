...
public class MemberDAO {
	...
	public int updateMember(MemberVO mVo) {
		...
		try{
			conn = DBManager.getConnection();
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, mVo.getMb_pass());
			pstmt.setString(2, mVo.getMb_email());
			pstmt.setString(3, mVo.getMb_zip());
			pstmt.setString(4, mVo.getMb_addr1());
			pstmt.setString(5, mVo.getMb_addr2());
			pstmt.setString(6, mVo.getMb_tel());
			pstmt.setString(7, mVo.getMb_hp());
			pstmt.setInt(8, mVo.getMb_mailing());
			pstmt.setInt(9, mVo.getMb_level());
			pstmt.setString(10, mVo.getMb_salt());
			pstmt.setString(11, mVo.getMb_id());
