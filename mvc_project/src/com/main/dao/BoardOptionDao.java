...
public class BoardOptionDao {
	...
	public int insertBoardOption(BoardOptionVO optionVo) {
		...
		int result = 0;
		// OP_IDX OP_NAME OP_TABLE OP_SKIN OP_ADM_SKIN OP_IS_SECRET OP_IS_IP OP_IS_SIGN OP_NEW_DATE OP_REGDATE            OP_VIEW_LEVEL OP_LIST_LEVEL OP_WRITE_LEVEL OP_COMMENT_LEVEL OP_REPLY_LEVEL OP_PAGE_LENGTH OP_IS_PREVIEW OP_IS_NOTICE OP_CATE
	...
	public int updateBoardOption(BoardOptionVO optionVo) {
		...
		try{
			...
			pstmt.setInt(17, optionVo.getOp_idx());
