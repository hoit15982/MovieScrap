		...
		<div class="board_write">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="op_page_length" id="op_page_length" value="${optionVo.op_page_length }" size="10" /></td>
				</tr>				
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="op_new_date" id="op_new_date" value="${optionVo.op_new_date }" size="10" /></td>
				</tr>					
			</table>
